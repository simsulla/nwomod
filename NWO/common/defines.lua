...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.2, -- how much foreign investment money counts towards your industry score
...
pops = {
	...
	BASE_GOODS_DEMAND = 1,
	BASE_POPGROWTH = -0.009, -- % per month:  reflects death rates with "some" aging TFR 1.8 is zero growth
