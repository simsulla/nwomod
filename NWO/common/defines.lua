...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.5, -- 0.2 -- Basic efficiency for taxes without 'crats and tech
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 250000, -- 1500
...
military = {
	...
	POP_MIN_SIZE_FOR_REGIMENT_COLONY_MULTIPLIER = 6, -- 4
	POP_MIN_SIZE_FOR_REGIMENT_NONCORE_MULTIPLIER = 6, -- 3 VALUE * POP_MIN_SIZE_FOR_REGIMENT is min for noncores
