...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.6, -- 0.5 -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.4, -- 0.2
	GOLD_TO_CASH_RATE = 1, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 6, -- 3.5 Multiplier for how much money gold pays to pops
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 5, -- TODO base value that is powered by level of naval base. Determines the naval supplying capabilities. 
...
diplomacy = {
	...
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.50, -- TODO How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
...
pops = {
	...
	MIL_LACK_EVERYDAY_NEED = 0.0, -- 0.05 TODO
	MIL_HAS_EVERYDAY_NEED = -0.075,
	MIL_HAS_LUXURY_NEED = -0.2,
	MIL_NO_LIFE_NEED = 0.0, -- 0.2 TODO
