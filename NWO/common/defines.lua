...
country = {
	...
	GOLD_TO_WORKER_PAY_RATE = 7.0, -- 3.5 Multiplier for how much money gold pays to pops
...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 900, -- 3 -- can loan max % of country tax base from single country
