...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.6, -- 0.2 -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.4, -- 0.2
	GOLD_TO_CASH_RATE = 0.5, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 10.0, -- 3.5 Multiplier for how much money gold pays to pops
...
economy = {
	...
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 2, -- 10
	BANKRUPTCY_FACTOR = 0.02, -- 0.2
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 1500000, -- 1500
	MAX_LOAN_CAP_FROM_BANKS = 900, -- 150 -- can loan max % of country tax base from single country
	...
	GOODS_FOCUS_SWAP_CHANCE = 0.1, -- Percent increased chance that artisan wants to change goods independantly of how well he is doing presently
	NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 4, -- 1 -- Number of closed factories allowed per state under Lassiez Faire
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 6,  -- 2 -- Min number of factories per state before starting to delete under Lassiez Faire
	...
	RGO_SUPPLY_DEMAND_FACTOR_FIRE = 0.2, -- 0.4		-- how fast pops are Fired when there is a low demand
	EMPLOYMENT_HIRE_LOWEST = 0.01,	-- 0.001		-- we Hire pops no slower then x% of total required per day
	EMPLOYMENT_FIRE_LOWEST = 0.01, -- 0.001			-- we Fire pops no slower then x% of total required per day
...
military = {
	...
	POP_MIN_SIZE_FOR_REGIMENT = 1000, -- 1000
	POP_SIZE_PER_REGIMENT = 3000, -- 3000
	...
	AI_ARMY_TAXBASE_FRACTION = 0.1, -- 0.3 max of tax base that AI will spend on army supply costs (based on peacetime costs)
	AI_NAVY_TAXBASE_FRACTION = 0.1, -- 0.3  max of tax base that AI will spend on navy supply costs (based on peacetime costs)
...
pops = {
	...
	LARGE_POPULATION_INFLUENCE_PENALTY_CHUNK = 9000000,
},
...
ai =
{
	...
	SOLDIER_FRACTION = 0.01, -- max amount of population AI wants to be soldiers -- orig 0.03
...
graphics =
{
	...
	CITIES_SIZE_MAX_POPULATION_K = 8000 -- 1000			-- When province population reach 1mln, the city will get it's maximum size.
}
